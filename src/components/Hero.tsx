  ...
  return (
    ...
    >
      ...
      <motion.a
        ...
        className="absolute bottom-10 left-1/2 -translate-x-1/2 text-slate-500 hidden md:flex flex-col items-center gap-2 hover:text-sky-400 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-sky-500 focus-visible:ring-offset-2 focus-visible:ring-offset-slate-900 rounded-sm transition-colors"
