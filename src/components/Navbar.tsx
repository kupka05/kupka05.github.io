    ...
    >
      <div className="container mx-auto px-6 md:px-12 flex justify-between items-center">
        {isEditing ? (
          ...
          <a href="#home" className="text-xl md:text-2xl font-bold tracking-tighter text-white focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-sky-500 focus-visible:ring-offset-2 focus-visible:ring-offset-slate-900 rounded-sm">
